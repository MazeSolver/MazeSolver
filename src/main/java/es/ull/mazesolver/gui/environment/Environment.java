...
public class Environment extends BaseInternalFrame {
     ...
     *
     * @param maze Laberinto en el que se basa el entorno. Puede ser compartido entre
     *             varios entornos.
     ...
     *
     * @param name Nuevo nombre del entorno.
     */
     ...
     *
     * @param mode Nuevo modo de interacción con el entorno.
     */
     ...
     *
     * @param results Objeto que representa el resultado de la simulación, que será
    ...
    @Override
    public int hashCode() {
        return Integer.valueOf(s_instance).hashCode();
    }
