...
import es.ull.mazesolver.agent.rules.parser.SituationActionParser.ActionContext;
...
public class RuleAction implements Cloneable {
     ...
     *
     * @param action_ctx Nodo del árbol de parseo donde se encuentra la acción a realizar.
     ...
     *
     * @param dir Dirección hacia la que realizar el movimiento.
     */
