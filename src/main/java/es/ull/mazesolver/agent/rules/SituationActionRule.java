...
public class SituationActionRule implements Cloneable {
     ...
     *
     * @param ctx Contexto de una regla dentro del árbol de parseo de una entrada.
     ...
     * acción ya creados.
     *
     * @param pred Predicado o situación.
     * @param act  Acción a realizar si se cumple la situación.
     */
     ...
     *
     * @param ag Agente que se quiere mover.
